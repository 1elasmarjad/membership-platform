  ...
  return (
    <div className="flex w-full max-w-sm flex-col rounded-lg bg-white px-4 py-8">
      <div className="flex w-full flex-col">
        ...
        <a
          className="mt-6 rounded-lg bg-blue-500 py-2.5 text-center font-bold text-white transition-all hover:bg-blue-400"
          href={data.buyLink}
        >
          Donate
        </a>
...
export function TierBlockSkeleton() {
  return (
    <div className="flex w-full max-w-sm flex-col rounded-lg bg-white px-4 py-8">
      <div className="flex w-full flex-col">
        ...
        <div
          className="mt-6 rounded-lg bg-blue-300 py-2.5 text-center font-bold text-white transition-all animate-pulse h-12"
        >
        </div>
      </div>
